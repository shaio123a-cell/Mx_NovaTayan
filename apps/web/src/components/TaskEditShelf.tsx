                    ...
                    <div style={{ flex: 1 }}>
                        <div className="flex flex-col">
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                {getEffectiveIcon(name) && (
                                    <div style={{ width: '24px', height: '24px', background: '#f9fafb', borderRadius: '6px', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid #eee', flexShrink: 0 }}>
                                        <img src={getEffectiveIcon(name)!} style={{ width: '16px', height: '16px', objectFit: 'contain' }} alt="preview" />
                                    </div>
                                )}
                                <input 
                                    value={name} 
