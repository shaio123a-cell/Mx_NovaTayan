...
export class WorkerController {
    ...
    async previewOutputMutation(@Body() body: { specYaml: string; inputText: string; vars?: any; workflowVars?: any; globalVars?: any }) {
        ...
        try {
            ...
            // Construct context for VariableEngine
            const context = {
                task: body.vars || {},
                workflow: body.workflowVars || {},
                global: body.globalVars || {}
            };
            
            const result = await transform(validation.spec, body.inputText, context, { previewLimit: 20 });
